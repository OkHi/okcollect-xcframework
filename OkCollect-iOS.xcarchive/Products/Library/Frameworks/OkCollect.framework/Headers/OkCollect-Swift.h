...
#ifndef OKCOLLECT_SWIFT_H
#define OKCOLLECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OkCollect",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9OkCollect10OkHiConfig")
...
SWIFT_CLASS("_TtC9OkCollect9OkHiTheme")
